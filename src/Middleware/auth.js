...
const Authentication = async (req, res, next) => {
    try {
        ...
        //=====================Verify token & assigning it's value in request body =====================//
...
//<<<=====================This function used for Authorization(Phase II)=====================>>>//
const Authorisation = async (req, res, next) => {

    try {

        //<<<===================== Authorizing with BookId From Param =====================>>>//
        ...
        //<<<===================== Authorizing with UserId form Body =====================>>>//
        let data = req.body
